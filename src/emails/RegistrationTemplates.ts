...
export const RegistrationEmailTemplate = (registration_link: string, otp: string) => {
  const bodyContent = `
      <p>Hi Student,</p>
      <br/>
      <p>
        Congratulations! You’ve been registered to <strong>Vocational Placement Management Platform</strong>. 
      </p>
      <p>
